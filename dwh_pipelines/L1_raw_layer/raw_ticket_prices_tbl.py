...
if USING_AIRFLOW:
    ...
    ticket_prices_path = config['postgres_airflow_config']['DATASET_SOURCE_PATH'] + os.sep + src_file
    ...
    config.read(path)
    ticket_prices_path     =   config['travel_data_filepath']['DATASETS_LOCATION_PATH'] + os.sep + src_file
