...
if USING_AIRFLOW:
    ...
    sales_agents_path = config['postgres_airflow_config']['DATASET_SOURCE_PATH'] + os.sep + src_file
    ...
    config.read(path)
    sales_agents_path     =   config['travel_data_filepath']['DATASETS_LOCATION_PATH'] + os.sep + src_file
