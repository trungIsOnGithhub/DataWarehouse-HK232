...
if USING_AIRFLOW:
    ...
    customer_feedbacks_path = config['postgres_airflow_config']['DATASET_SOURCE_PATH'] + os.sep + src_file
    ...
    config.read(path)
    customer_feedbacks_path     =   config['travel_data_filepath']['DATASETS_LOCATION_PATH'] + os.sep + src_file
