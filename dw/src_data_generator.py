...
field_styles = dict(messages = dict(color='white'))
  ...
  file_handler = logging.FileHandler('logs/L0/data_gen.log', mode='w')
  ...
  # Constants for generating the synthetic data 
...
#   path = os.path.abspath('dwh_pipelines/local_config.ini')
  ...
  DATASETS_LOCATION_PATH = os.path.dirname(os.path.abspath(__file__)) + "/jsondata"

  # print(DATASETS_LOCATION_PATH)
  ...
  with open(f'{DATASETS_LOCATION_PATH}/customer_info.json', 'a') as customer_info_file:
  ...
  # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/ticket_prices.json', 'a') as ticket_prices_file:
  ...
  # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/flight_bookings.json', 'a') as flight_bookings_file:
  ...
  # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/customer_feedbacks.json', 'a') as customer_feedbacks_file:
  ...
  # # Write dataframe to JSON file 
  with open(f'{DATASETS_LOCATION_PATH}/sales_agents.json', 'a') as sales_agents_file:
  ...
  # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/flight_destinations.json', 'a') as flight_destinations_file:
  ...
  flight_promotion_deals_df = pd.DataFrame(load_flight_promotion_deals_via_generator())
    ...
    # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/flight_promotion_deals.json', 'a') as flight_promotion_deals_file:
  ...
  # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/flight_ticket_sales.json', 'a') as flight_ticket_sales_file:
  ...
  # Write dataframe to JSON file
  with open(f'{DATASETS_LOCATION_PATH}/accommodation_bookings.json', 'a') as accommodation_bookings_file:
